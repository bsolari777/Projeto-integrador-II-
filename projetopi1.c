...
void executarinstrucao(struct memoria_instrucao mem[], int contador, int reg[], int memdados[], int *pc, struct estado **historico, int *topo, int *capacidade);
...
void executarinstrucao(struct memoria_instrucao mem[], 
                        int contador, int reg[], int memdados[], int *pc,
                        struct estado **historico, int *topo, int *capacidade){
